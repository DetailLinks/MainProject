 ...
 * 参数：playerView ：AliyunVodPlayerView
 */
- (void)downloadBtnClick:(AliyunVodPlayerView *)playerView;
/**
 * 功能：转换为音频按钮
 * 参数：playerView ：AliyunVodPlayerView
 */
- (void)listenBtnClick:(AliyunVodPlayerView *)playerView;

/**
 * 功能  分享按钮
 * 参数：playerView ：AliyunVodPlayerView
 */
- (void)shareBtnClick:(AliyunVodPlayerView *)playerView;

/**
 * 功能：多选项按钮
 * 参数：playerView ：AliyunVodPlayerView
 */
- (void)editeBtnClick:(AliyunVodPlayerView *)playerView;
