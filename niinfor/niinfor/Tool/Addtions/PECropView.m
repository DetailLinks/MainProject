...
static const CGFloat MarginTop = 0;//37.0f;
static const CGFloat MarginBottom = MarginTop;
static const CGFloat MarginLeft = 0;//20.0f;
...
- (void)setupImageView
{
    ...
    NSLog(@"%@ , %@ %@",NSStringFromCGRect(cropRect), NSStringFromCGSize(self.image.size),NSStringFromCGRect(self.insetRect));
